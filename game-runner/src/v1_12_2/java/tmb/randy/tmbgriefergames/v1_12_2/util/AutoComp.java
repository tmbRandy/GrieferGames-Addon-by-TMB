...
public class AutoComp {
    ...
    public void onKeyEvent(KeyEvent event) {
        if(event.state() == State.PRESS) {
            if (isCompActive() && Minecraft.getMinecraft().player.openContainer != null) {
    ...
    public void changeList(boolean increase) {
        ...
        Addon.getSharedInstance().displayNotification(I18n.getTranslation("tmbgriefergames.autoComp.list") + (currentList + 1));
    }
